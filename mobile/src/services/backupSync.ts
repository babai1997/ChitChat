...
// Phase 4b (passphrase-encrypted chat backup, see E2EE_PLAN.md) — mirrors
// frontend/src/services/backupSync.ts. Reuses collectHistorySnapshot /
// applyDecryptedEntries from deviceLinkSync.ts — only the encryption
// source differs: a passphrase-derived key instead of a pairwise Session
// with another device.

/** Creates or overwrites this account's backup. Returns the entry count for the success message. */
